...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Error: No recordss",cursor.moveToFirst());

        TestUtilities.validateCurrentRecord("Error: Validacion failed",cursor,values);

        assertFalse("Error: mas de un resultado",cursor.moveToNext());
